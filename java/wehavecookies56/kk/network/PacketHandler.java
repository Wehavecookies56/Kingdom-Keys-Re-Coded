...
public class PacketHandler extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
	...
	public PacketHandler(String packetsPackage) {
		try {
			ImmutableSet<ClassInfo> set = ClassPath.from(PacketHandler.class.getClassLoader()).getTopLevelClassesRecursive(packetsPackage);
