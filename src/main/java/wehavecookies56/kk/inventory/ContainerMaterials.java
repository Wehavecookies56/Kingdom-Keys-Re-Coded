...
public class ContainerMaterials extends Container
{
	...
	public ContainerMaterials(EntityPlayer player, InventoryPlayer inventoryPlayer, InventoryKeychain inventoryKeychain) {
		int i;
