...
public class GuiOverlay extends GuiScreen {
	...
	public void RenderGameOverlayEvent(RenderGameOverlayEvent event) {
		if (event.type == ElementType.TEXT) {
			...
			String reqExp = ""
					+ (Arrays.stream(PlayerLevel.expNeeded, 0, ExtendedPlayer.get(mc.thePlayer).getLevel()).sum()
							- ExtendedPlayer.get(mc.thePlayer).getXP());
			if (showExp) {
			...
			if (showMunny) {
				if (!showExp) {
					...
					mc.fontRendererObj.drawString(munnyGet + "", 5, 5 + (mc.fontRendererObj.FONT_HEIGHT * 2) + 10,
							0xFFFFFF);
				}
			...
			if (showLevelUp) {
				...
				GL11.glPushMatrix();
				{
					...
					GL11.glColor4ub((byte) Config.interfaceColour[0], (byte) Config.interfaceColour[1],
							(byte) Config.interfaceColour[2], (byte) 255);
					GL11.glPushMatrix();
					{
						...
						GL11.glPushMatrix();
						{
							GL11.glTranslatef(width - ((mc.fontRendererObj.getStringWidth("LEVEL UP!")) * 0.75f) - 115,
									4, 0);
						...
						GL11.glPushMatrix();
						{
							GL11.glPushMatrix();
							{
								GL11.glTranslatef(width - ((mc.fontRendererObj.getStringWidth("LV. ")) * 0.75f) - 90, 4,
										0);
								GL11.glScalef(0.75f, 0.75f, 1);
							...
							GL11.glPushMatrix();
							{
								GL11.glTranslatef(width - 256.0f * 0.75f
										+ ((mc.fontRendererObj.getStringWidth("999")) * 0.75f) + 88, 4, 0);
								GL11.glScalef(0.75f, 0.75f, 1);
								drawString(mc.fontRendererObj, "" + ExtendedPlayer.get(mc.thePlayer).getLevel(), 0, 0,
										0xFFFFFF);
							}
							GL11.glPopMatrix();
							GL11.glPushMatrix();
							{
								GL11.glTranslatef(
										width - ((mc.fontRendererObj
												.getStringWidth(mc.thePlayer.getDisplayNameString())) * 0.75f) - 7,
										4, 0);
								GL11.glScalef(0.75f, 0.75f, 1);
					...
					for (int i = 0; i < PlayerLevel.messages.size(); i++) {
						GL11.glPushMatrix();
						{
							...
							GL11.glTranslatef(
									(width - 256.0f * 0.8f
											+ (mc.fontRendererObj.getStringWidth("Maximum HP Increased!")) * 0.8f),
									mc.fontRendererObj.FONT_HEIGHT * 0.8f * i + 23, 0);
