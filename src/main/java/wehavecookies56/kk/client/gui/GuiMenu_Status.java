...
public class GuiMenu_Status extends GuiMenu_Bars {
	...
	final int STATS_PLAYER = 0, STATS_VALOR = 1, STATS_WISDOM = 2, STATS_LIMIT = 3, STATS_MASTER = 4, STATS_FINAL = 5,
			STATS_BACK = 6;
	...
	public void initGui() {
		...
		buttonList.add(stats_player = new GuiButton(STATS_PLAYER, 5, button_stats_playerY, 100, 20,
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		case STATS_PLAYER:
			...
			drawString(fontRendererObj,
					"" + ((Arrays.stream(PlayerLevel.expNeeded, 0, ep.getLevel()).sum()) - ep.getXP()), 230,
					((-140 / 16) + 75) + 34, 0xFFD900);
