...
public class GuiMenu_Items extends GuiMenu_Bars {
	...
	public void initGui() {
		...
		buttonList.add(items_player = new GuiButton(ITEMS_PLAYER, 5, button_items_playerY, 100, 20,
				mc.thePlayer.getDisplayNameString()));
		buttonList.add(items_stock = new GuiButton(ITEMS_STOCK, 5, button_items_stockY, 100, 20,
				TextHelper.localize(Strings.Gui_Menu_Items_Button_Stock)));
		buttonList.add(items_back = new GuiButton(ITEMS_BACK, 5, button_items_backY, 100, 20,
