...
public class GuiSynthBag extends GuiContainer {
	...
	private final InventorySynthBagMenu inventory;

	public GuiSynthBag(EntityPlayer player, InventoryPlayer inventoryPlayer, InventorySynthBagMenu inventorySyntheBagMenu) {
		super(new ContainerSynthBagMenu(player, inventoryPlayer, inventorySyntheBagMenu));
		this.inventory = inventorySyntheBagMenu;
	}
