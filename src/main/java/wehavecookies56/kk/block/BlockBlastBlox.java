...
public class BlockBlastBlox extends BlockBlox {
	...
	public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entity) {
		explode(world, pos.getX(), pos.getY(), pos.getZ(), 1,
	...
	public void onBlockDestroyedByExplosion(World par1World, BlockPos pos, Explosion par5Explosion) {
		if (!par1World.isRemote) {
			EntityBlastBlox entitytntprimed = new EntityBlastBlox(par1World, pos.getX() + 0.5F, pos.getY() + 0.5F,
					pos.getZ() + 0.5F, par5Explosion.getExplosivePlacedBy());
	...
	public void onBlockDestroyedByPlayer(World world, BlockPos pos, IBlockState state) {
		...
		if (Minecraft.getMinecraft().thePlayer.getHeldItem().getItem() == Items.apple)
			explode(world, pos.getX(), pos.getY(), pos.getZ(), state.getBlock().getMetaFromState(state),
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumFacing side,
		...
		if (player.getCurrentEquippedItem() != null
				&& player.getCurrentEquippedItem() == new ItemStack(Items.flint_and_steel)) {
