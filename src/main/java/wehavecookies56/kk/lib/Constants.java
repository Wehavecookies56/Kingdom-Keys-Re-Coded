...
public class Constants {
	...
	// Input
	LEFT_MOUSE = 0, RIGHT_MOUSE = 1, MIDDLE_MOUSE = 2, WHEEL_UP = -1, WHEEL_DOWN = 1,

			// MC Gamesettings
			// Gui scale
			SCALE_AUTO = 0, SCALE_SMALL = 1, SCALE_NORMAL = 2, SCALE_LARGE = 3,
	...
	public static void registerCosts() {
		...
		costs.put("gui.commandmenu.drive.limit", 400);
		costs.put("gui.commandmenu.drive.master", 400);
		costs.put("gui.commandmenu.drive.final", 500);
