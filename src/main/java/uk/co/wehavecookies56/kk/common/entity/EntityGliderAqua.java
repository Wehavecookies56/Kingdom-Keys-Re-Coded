...
public class EntityGliderAqua extends Entity {
	private static final DataParameter<Integer> TIME_SINCE_HIT = EntityDataManager.<Integer>createKey(EntityGliderAqua.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> FORWARD_DIRECTION = EntityDataManager.<Integer>createKey(EntityGliderAqua.class, DataSerializers.VARINT);
	private static final DataParameter<Float> DAMAGE_TAKEN = EntityDataManager.<Float>createKey(EntityGliderAqua.class, DataSerializers.FLOAT);
	private static final DataParameter<Integer> BOAT_TYPE = EntityDataManager.<Integer>createKey(EntityGliderAqua.class, DataSerializers.VARINT);
	private static final DataParameter<Boolean>[] DATA_ID_PADDLE = new DataParameter[] { EntityDataManager.createKey(EntityGliderAqua.class, DataSerializers.BOOLEAN), EntityDataManager.createKey(EntityGliderAqua.class, DataSerializers.BOOLEAN) };
	...
	public void applyEntityCollision(Entity entityIn) {
		if (entityIn instanceof EntityGliderAqua) {
