 ...
 */
public class ChunkProviderTraverseTown implements IChunkGenerator {
    ...
    public ChunkProviderTraverseTown(World worldObjIn, boolean mapFeaturesEnabledIn, long seed) {
