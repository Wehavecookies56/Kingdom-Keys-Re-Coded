 ...
 */
public class EntityCombustion extends EntityThrowable implements IThrowableEntity {
    EntityPlayer player;

    public EntityCombustion (World world) {
        super(world);
    }

    public EntityCombustion (World world, EntityLivingBase entity) {
        super(world, entity);
        this.player = (EntityPlayer) entity;
    }

    public EntityCombustion (World world, double x, double y, double z) {
        super(world, x, y, z);
    }
