...
public class LostKnowledgePacket extends AbstractMessage.AbstractServerMessage<LostKnowledgePacket> {
    public LostKnowledgePacket () {}
        ...
        int rand = Utils.randomWithRange(0, Lists.Larxene.size() - 1);
        player.inventory.addItemStackToInventory(new ItemStack(Lists.Larxene.get(rand)));
        TextComponentTranslation manifestMessage = new TextComponentTranslation(Strings.Chat_Manifest, new TextComponentTranslation(Lists.Larxene.get(rand).getUnlocalizedName() + ".name"));
