...
public class EntityGliderTerra extends Entity {
	...
	private static final DataParameter<Integer> BOAT_TYPE = EntityDataManager.<Integer>createKey(EntityGliderTerra.class, DataSerializers.VARINT);
	private static final DataParameter<Boolean>[] DATA_ID_PADDLE = new DataParameter[] { EntityDataManager.createKey(EntityGliderTerra.class, DataSerializers.BOOLEAN), EntityDataManager.createKey(EntityGliderTerra.class, DataSerializers.BOOLEAN) };
	...
	public EntityGliderTerra(World worldIn) {
		super(worldIn);
		this.preventEntitySpawning = true;
		this.setSize(2F, 2F);
	}

	public EntityGliderTerra(World worldIn, double x, double y, double z) {
		this(worldIn);
	...
	public void applyEntityCollision(Entity entityIn) {
		if (entityIn instanceof EntityGliderTerra) {
