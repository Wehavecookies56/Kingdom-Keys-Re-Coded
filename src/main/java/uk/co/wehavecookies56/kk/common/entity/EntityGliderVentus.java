...
public class EntityGliderVentus extends Entity {
	private static final DataParameter<Integer> TIME_SINCE_HIT = EntityDataManager.<Integer>createKey(EntityGliderVentus.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> FORWARD_DIRECTION = EntityDataManager.<Integer>createKey(EntityGliderVentus.class, DataSerializers.VARINT);
	private static final DataParameter<Float> DAMAGE_TAKEN = EntityDataManager.<Float>createKey(EntityGliderVentus.class, DataSerializers.FLOAT);
	private static final DataParameter<Integer> BOAT_TYPE = EntityDataManager.<Integer>createKey(EntityGliderVentus.class, DataSerializers.VARINT);
	private static final DataParameter<Boolean>[] DATA_ID_PADDLE = new DataParameter[] { EntityDataManager.createKey(EntityGliderVentus.class, DataSerializers.BOOLEAN), EntityDataManager.createKey(EntityGliderVentus.class, DataSerializers.BOOLEAN) };
	...
	public EntityGliderVentus(World worldIn) {
		super(worldIn);
		this.preventEntitySpawning = true;
		this.setSize(2F, 2F);
	}

	public EntityGliderVentus(World worldIn, double x, double y, double z) {
		this(worldIn);
	...
	public void applyEntityCollision(Entity entityIn) {
		if (entityIn instanceof EntityGliderVentus) {
