...
public class XemnasMemberSelect extends AbstractMessage.AbstractServerMessage<XemnasMemberSelect> {

        Utils.OrgMember member;

public XemnasMemberSelect() {

        }

public XemnasMemberSelect(Utils.OrgMember member) {
        this.member = member;
        }
