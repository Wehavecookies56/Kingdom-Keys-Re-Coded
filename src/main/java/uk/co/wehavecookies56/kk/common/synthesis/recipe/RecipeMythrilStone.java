 ...
 */
public class RecipeMythrilStone extends Recipe {

    public String name;

    public RecipeMythrilStone(String name) {
        this.name = name;
    }
    ...
    public ItemStack getResult () {
        ...
        stack.getTagCompound().setString("material", Strings.SM_MythrilStone);
        stack.getTagCompound().setString("rank", Strings.SM_Rank_B);
        return stack;
    }
