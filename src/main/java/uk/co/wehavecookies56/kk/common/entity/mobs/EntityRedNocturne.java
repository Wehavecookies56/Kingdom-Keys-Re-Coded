...
public class EntityRedNocturne extends BaseEntityHeartless implements IKHMob
{
	...
	public EntityRedNocturne(World world)
	{
		...
		this.tasks.addTask(0, new EntityRedNocturneAI(this));
	...
	public boolean attackEntityFrom(DamageSource source, float amount)
	{
		...
		{
			if(source.getImmediateSource() instanceof EntityBlizzard || source.getImmediateSource() instanceof EntityBlizzara || source.getImmediateSource() instanceof EntityBlizzaga)
				multiplier = 2;
		}
	...
	class EntityRedNocturneAI extends EntityAIBase
	{
		private EntityRedNocturne theEntity;
		private boolean canUseAttack = true;
		private int attackTimer = 5, whileAttackTimer;

		public EntityRedNocturneAI(EntityRedNocturne e)
		{
			this.theEntity = e;
		}
