 ...
 */
public class EntityMoulinRouge extends EntityThrowable implements IThrowableEntity {
    EntityPlayer player;

    public EntityMoulinRouge (World world) {
        super(world);
    }

    public EntityMoulinRouge (World world, EntityLivingBase entity) {
        super(world, entity);
        this.player = (EntityPlayer) entity;
    }

    public EntityMoulinRouge (World world, double x, double y, double z) {
        super(world, x, y, z);
    }
    ...
    public void onUpdate ()
    {
        ...
        if (returning) {
            ...
            List entityTagetList = this.world.getEntitiesWithinAABB(
                    Entity.class, this.getEntityBoundingBox().grow(1.0D, 1.0D, 1.0D));
