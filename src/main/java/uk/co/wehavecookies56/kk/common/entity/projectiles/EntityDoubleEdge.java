 ...
 */
public class EntityDoubleEdge  extends EntityThrowable implements IThrowableEntity {
    EntityPlayer player;

    public EntityDoubleEdge (World world) {
        super(world);
    }

    public EntityDoubleEdge (World world, EntityLivingBase entity) {
        super(world, entity);
        this.player = (EntityPlayer) entity;
    }

    public EntityDoubleEdge (World world, double x, double y, double z) {
        super(world, x, y, z);
    }
