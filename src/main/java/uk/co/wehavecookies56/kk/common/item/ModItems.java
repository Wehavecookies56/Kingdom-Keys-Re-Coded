...
public class ModItems {
	...
	public static void init () {
		...
		int testStr = 1;
		int TestMag = 1;
		AbaddonPlasma = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.AbaddonPlasma);
		AbyssalTide = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.AbyssalTide);
		AllforOne = new ItemRealKeyblade(30,24).setUnlocalizedName(Strings.AllforOne);
		AnguisForetellersKeyblade = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.AnguisForetellersKeyblade);
		AstralBlast = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.AstralBlast);
		Aubade = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.Aubade);
		BondofFlame = new ItemRealKeyblade(12,8).setUnlocalizedName(Strings.BondofFlame);
		Brightcrest = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.Brightcrest);
		...
		FrolicFlame = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.FrolicFlame);
		GlimpseofDarkness = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.GlimpseofDarkness);
		...
		LeasKeyblade = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.LeasKeyblade);
		...
		MastersDefender = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.MastersDefender);
		MaverickFlare = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.MaverickFlare);
		MetalChocobo = new ItemRealKeyblade(30,-2).setUnlocalizedName(Strings.MetalChocobo);
		MidnightRoar = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.MidnightRoar);
		MirageSplit = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.MirageSplit);
		MissingAche = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.MissingAche);
		...
		NightmaresEnd = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.NightmaresEnd);
		NightmaresEndandMirageSplit = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.NightmaresEndandMirageSplit);
		...
		OmegaWeapon = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.OmegaWeapon);
		OminousBlight = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.OminousBlight);
		OneWingedAngel = new ItemRealKeyblade(24,-4).setUnlocalizedName(Strings.OneWingedAngel);
		PainofSolitude = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.PainofSolitude);
		...
		RejectionofFate = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.RejectionofFate);
		...
		SignofInnocence = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.SignofInnocence);
		SilentDirge = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.SilentDirge);
		...
		SoulEater = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.SoulEater);
		Spellbinder = new ItemRealKeyblade(12,4).setUnlocalizedName(Strings.Spellbinder);
		Starlight = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.Starlight);
		StarSeeker = new ItemRealKeyblade(9,2).setUnlocalizedName(Strings.StarSeeker);
		Stormfall = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.Stormfall);
		...
		SweetMemories = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.SweetMemories);
		...
		TotalEclipse = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.TotalEclipse);
		TreasureTrove = new ItemRealKeyblade(9,4).setUnlocalizedName(Strings.TreasureTrove);
		TrueLightsFlight = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.TrueLightsFlight);
		TwilightBlaze = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.TwilightBlaze);
		...
		Umbrella = new ItemKeyblade(testStr, TestMag).setUnlocalizedName(Strings.Umbrella);
		Unbound = new ItemRealKeyblade(27,28).setUnlocalizedName(Strings.Unbound);
		UnicornisForetellersKeyblade = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.UnicornisForetellersKeyblade);
		UrsusForetellersKeyblade = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.UrsusForetellersKeyblade);
		...
		VulpeusForetellersKeyblade = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.VulpeusForetellersKeyblade);
		...
		WoodenKeyblade = new ItemKeyblade(testStr, TestMag).setUnlocalizedName(Strings.WoodenKeyblade);
		WoodenStick = new ItemKeyblade(testStr, TestMag).setUnlocalizedName(Strings.WoodenStick);
		YoungXehanortsKeyblade = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.YoungXehanortsKeyblade);
		ZeroOne = new ItemRealKeyblade(testStr, TestMag).setUnlocalizedName(Strings.ZeroOne);
