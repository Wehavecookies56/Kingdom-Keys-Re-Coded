...
public class ModItems {
    ...
    public static final Item[] ITEMS = {
            ...
            Killerbee = new ItemArrowguns(Strings.Killerbee, BalanceConfig.orgweapons.killerbee, 16, 50),
            Stingray = new ItemArrowguns(Strings.Stingray, BalanceConfig.orgweapons.stingray, 36 , 50),
            Counterweight = new ItemArrowguns(Strings.Counterweight, BalanceConfig.orgweapons.counterweight, 36 , 50),
            Precision = new ItemArrowguns(Strings.Precision, BalanceConfig.orgweapons.precision, 16 , 50),
            DualHead = new ItemArrowguns(Strings.DualHead, BalanceConfig.orgweapons.dualhead, 9 , 50),
            Bahamut = new ItemArrowguns(Strings.Bahamut, BalanceConfig.orgweapons.bahamut, 9 , 50),
            Gullwing = new ItemArrowguns(Strings.Gullwing, BalanceConfig.orgweapons.gullwing, 24 , 50),
            BlueFrame = new ItemArrowguns(Strings.BlueFrame, BalanceConfig.orgweapons.blueframe, 24 , 50),
            StarShell = new ItemArrowguns(Strings.StarShell, BalanceConfig.orgweapons.starshell, 12 , 50),
            Sunrise = new ItemArrowguns(Strings.Sunrise, BalanceConfig.orgweapons.sunrise, 12 , 50),
            Ignition = new ItemArrowguns(Strings.Ignition, BalanceConfig.orgweapons.ignition, 16 , 50),
            Armstrong = new ItemArrowguns(Strings.Armstrong, BalanceConfig.orgweapons.armstrong, 3 , 50),
            HardBoiledHeat = new ItemArrowguns(Strings.HardBoiledHeat, BalanceConfig.orgweapons.hardboiledheat, 12 , 50),
            DiabloEye = new ItemArrowguns(Strings.DiabloEye, BalanceConfig.orgweapons.diabloeye, 36, 50),
            DoubleTap = new ItemArrowguns(Strings.DoubleTap, BalanceConfig.orgweapons.doubletap, 36 , 50),
            Stardust = new ItemArrowguns(Strings.Stardust, BalanceConfig.orgweapons.stardust, 24 , 50),
            EnergyMuzzle = new ItemArrowguns(Strings.EnergyMuzzle, BalanceConfig.orgweapons.energymuzzle, 24 , 50),
            CrimeAndPunishment = new ItemArrowguns(Strings.CrimeAndPunishment, BalanceConfig.orgweapons.crimeandpunishment, 12 , 50),
            CupidsArrow = new ItemArrowguns(Strings.CupidsArrow, BalanceConfig.orgweapons.cupidsarrow, 12 , 50),
            FinalWeapon = new ItemArrowguns(Strings.FinalWeapon, BalanceConfig.orgweapons.finalweapon, 24 , 50),
            Sharpshooter = new ItemArrowguns(Strings.Sharpshooter, BalanceConfig.orgweapons.sharpshooter, 32 , 50),
            Dryer = new ItemArrowguns(Strings.Dryer, BalanceConfig.orgweapons.dryer, 12 , 50),
            Trumpet = new ItemArrowguns(Strings.Trumpet, BalanceConfig.orgweapons.trumpet, 12 , 50),
