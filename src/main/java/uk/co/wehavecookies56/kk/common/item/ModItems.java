...
public class ModItems {
	...
	public static void init () {
		...
		FairyHarp = new ItemRealKeyblade(24,2).setUnlocalizedName(Strings.FairyHarp);
		FairyStars = new ItemRealKeyblade(6,6).setUnlocalizedName(Strings.FairyStars);
		FatalCrest = new ItemRealKeyblade(9,10).setUnlocalizedName(Strings.FatalCrest);
		Fenrir = new ItemRealKeyblade(21,2).setUnlocalizedName(Strings.Fenrir);
		FerrisGear = new ItemRealKeyblade(24,16).setUnlocalizedName(Strings.FerrisGear);
		FollowtheWind = new ItemRealKeyblade(9,2).setUnlocalizedName(Strings.FollowtheWind);
		...
		GuardianBell = new ItemRealKeyblade(21,20).setUnlocalizedName(Strings.GuardianBell);
		GuardianSoul = new ItemRealKeyblade(15,2).setUnlocalizedName(Strings.GuardianSoul);
		GullWing = new ItemRealKeyblade(6,6).setUnlocalizedName(Strings.GullWing);
		HerosCrest = new ItemRealKeyblade(12,0).setUnlocalizedName(Strings.HerosCrest);
		HiddenDragon = new ItemRealKeyblade(6,4).setUnlocalizedName(Strings.HiddenDragon);
		Hyperdrive = new ItemRealKeyblade(12,6).setUnlocalizedName(Strings.Hyperdrive);
		IncompleteKiblade = new ItemRealKeyblade(18,6).setUnlocalizedName(Strings.IncompleteKiblade);
		...
		MetalChocobo = new ItemRealKeyblade(30,-2).setUnlocalizedName(Strings.MetalChocobo);
		...
		Monochrome = new ItemRealKeyblade(9,4).setUnlocalizedName(Strings.Monochrome);
		MysteriousAbyss = new ItemRealKeyblade(9,6).setUnlocalizedName(Strings.MysteriousAbyss);
		...
		NoName = new ItemRealKeyblade(18,14).setUnlocalizedName(Strings.NoName);
		Oathkeeper = new ItemRealKeyblade(18,6).setUnlocalizedName(Strings.Oathkeeper);
		Oblivion = new ItemRealKeyblade(21,4).setUnlocalizedName(Strings.Oblivion);
		OceansRage = new ItemRealKeyblade(24,20).setUnlocalizedName(Strings.OceansRage);
		Olympia = new ItemRealKeyblade(27,0).setUnlocalizedName(Strings.Olympia);
		...
		OneWingedAngel = new ItemRealKeyblade(24,-4).setUnlocalizedName(Strings.OneWingedAngel);
		PainofSolitude = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.PainofSolitude);
		PhotonDebugger = new ItemRealKeyblade(9,4).setUnlocalizedName(Strings.PhotonDebugger);
		PixiePetal = new ItemRealKeyblade(9,12).setUnlocalizedName(Strings.PixiePetal);
		Pumpkinhead = new ItemRealKeyblade(21,0).setUnlocalizedName(Strings.Pumpkinhead);
		Rainfell = new ItemRealKeyblade(6,4).setUnlocalizedName(Strings.Rainfell);
		RejectionofFate = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.RejectionofFate);
		RoyalRadiance = new ItemRealKeyblade(24,14).setUnlocalizedName(Strings.RoyalRadiance);
		RumblingRose = new ItemRealKeyblade(15,0).setUnlocalizedName(Strings.RumblingRose);
		...
		SkullNoise = new ItemRealKeyblade(21,14).setUnlocalizedName(Strings.SkullNoise);
		SleepingLion = new ItemRealKeyblade(15,6).setUnlocalizedName(Strings.SleepingLion);
		SoulEater = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.SoulEater);
		Spellbinder = new ItemRealKeyblade(12,4).setUnlocalizedName(Strings.Spellbinder);
		Starlight = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Starlight);
		StarSeeker = new ItemRealKeyblade(9,2).setUnlocalizedName(Strings.StarSeeker);
		Stormfall = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Stormfall);
		StrokeofMidnight = new ItemRealKeyblade(6,4).setUnlocalizedName(Strings.StrokeofMidnight);
		SweetDreams = new ItemRealKeyblade(21,24).setUnlocalizedName(Strings.SweetDreams);
		SweetMemories = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.SweetMemories);
		Sweetstack = new ItemRealKeyblade(18,8).setUnlocalizedName(Strings.Sweetstack);
		ThreeWishes = new ItemRealKeyblade(18,0).setUnlocalizedName(Strings.ThreeWishes);
		TotalEclipse = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.TotalEclipse);
		TreasureTrove = new ItemRealKeyblade(9,4).setUnlocalizedName(Strings.TreasureTrove);
		...
		TwoBecomeOne = new ItemRealKeyblade(15,8).setUnlocalizedName(Strings.TwoBecomeOne);
		UltimaWeaponKH1 = new ItemRealKeyblade(36,20).setUnlocalizedName(Strings.UltimaWeaponKH1);
		UltimaWeaponKH2 = new ItemRealKeyblade(36,20).setUnlocalizedName(Strings.UltimaWeaponKH2);
		UltimaWeaponBBS = new ItemRealKeyblade(36,20).setUnlocalizedName(Strings.UltimaWeaponBBS);
		UltimaWeaponDDD = new ItemRealKeyblade(36,20).setUnlocalizedName(Strings.UltimaWeaponDDD);
		Umbrella = new ItemKeyblade(KEYBLADE).setUnlocalizedName(Strings.Umbrella);
		Unbound = new ItemRealKeyblade(27,28).setUnlocalizedName(Strings.Unbound);
		...
		VictoryLine = new ItemRealKeyblade(12,4).setUnlocalizedName(Strings.VictoryLine);
		VoidGear = new ItemRealKeyblade(24,8).setUnlocalizedName(Strings.VoidGear);
		VulpeusForetellersKeyblade = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.VulpeusForetellersKeyblade);
		WaytotheDawn = new ItemRealKeyblade(15,8).setUnlocalizedName(Strings.WaytotheDawn);
		WaywardWind = new ItemRealKeyblade(9,2).setUnlocalizedName(Strings.WaywardWind);
		WinnersProof = new ItemRealKeyblade(15,14).setUnlocalizedName(Strings.WinnersProof);
		WishingLamp = new ItemRealKeyblade(12,6).setUnlocalizedName(Strings.WishingLamp);
		WishingStar = new ItemRealKeyblade(18,0).setUnlocalizedName(Strings.WishingStar);
