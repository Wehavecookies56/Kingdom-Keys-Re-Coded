...
public class ModItems {
    ...
    public static final Item[] ITEMS = {
            ...
            Standalone = new ItemArrowguns(Strings.Standalone, BalanceConfig.orgweapons.standalone, 10 , 50),
            Killerbee = new ItemArrowguns(Strings.Killerbee, BalanceConfig.orgweapons.killerbee, 10 , 50),
            Stingray = new ItemArrowguns(Strings.Stingray, BalanceConfig.orgweapons.stingray, 10 , 50),
            Counterweight = new ItemArrowguns(Strings.Counterweight, BalanceConfig.orgweapons.counterweight, 10 , 50),
            Precision = new ItemArrowguns(Strings.Precision, BalanceConfig.orgweapons.precision, 10 , 50),
            DualHead = new ItemArrowguns(Strings.DualHead, BalanceConfig.orgweapons.dualhead, 10 , 50),
            Bahamut = new ItemArrowguns(Strings.Bahamut, BalanceConfig.orgweapons.bahamut, 10 , 50),
            Gullwing = new ItemArrowguns(Strings.Gullwing, BalanceConfig.orgweapons.gullwing, 10 , 50),
            BlueFrame = new ItemArrowguns(Strings.BlueFrame, BalanceConfig.orgweapons.blueframe, 10 , 50),
            StarShell = new ItemArrowguns(Strings.StarShell, BalanceConfig.orgweapons.starshell, 10 , 50),
            Sunrise = new ItemArrowguns(Strings.Sunrise, BalanceConfig.orgweapons.sunrise, 10 , 50),
            Ignition = new ItemArrowguns(Strings.Ignition, BalanceConfig.orgweapons.ignition, 10 , 50),
            Armstrong = new ItemArrowguns(Strings.Armstrong, BalanceConfig.orgweapons.armstrong, 10 , 50),
            HardBoiledHeat = new ItemArrowguns(Strings.HardBoiledHeat, BalanceConfig.orgweapons.hardboiledheat, 10 , 50),
            DiabloEye = new ItemArrowguns(Strings.DiabloEye, BalanceConfig.orgweapons.diabloeye, 10 , 50),
            DoubleTap = new ItemArrowguns(Strings.DoubleTap, BalanceConfig.orgweapons.doubletrap, 10 , 50),
            Stardust = new ItemArrowguns(Strings.Stardust, BalanceConfig.orgweapons.stardust, 10 , 50),
            EnergyMuzzle = new ItemArrowguns(Strings.EnergyMuzzle, BalanceConfig.orgweapons.energymuzzle, 10 , 50),
            CrimeAndPunishment = new ItemArrowguns(Strings.CrimeAndPunishment, BalanceConfig.orgweapons.crimeandpunishment, 10 , 50),
            CupidsArrow = new ItemArrowguns(Strings.CupidsArrow, BalanceConfig.orgweapons.cupidsarrow, 10 , 50),
            FinalWeapon = new ItemArrowguns(Strings.FinalWeapon, BalanceConfig.orgweapons.finalweapon, 10 , 50),
            Sharpshooter = new ItemArrowguns(Strings.Sharpshooter, BalanceConfig.orgweapons.sharpshooter, 10 , 50),
            Dryer = new ItemArrowguns(Strings.Dryer, BalanceConfig.orgweapons.dryer, 10 , 50),
            Trumpet = new ItemArrowguns(Strings.Trumpet, BalanceConfig.orgweapons.trumpet, 10 , 50),
            ...
            // keyblades
            AbaddonPlasma = new ItemRealKeyblade(Strings.AbaddonPlasma, BalanceConfig.keyblades.abaddonPlasma[0], BalanceConfig.keyblades.abaddonPlasma[1], Strings.guard, 5F),
            AbyssalTide = new ItemRealKeyblade(Strings.AbyssalTide, BalanceConfig.keyblades.abyssalTide[0], BalanceConfig.keyblades.abyssalTide[1], Strings.guard, 5F),
            AllforOne = new ItemRealKeyblade(Strings.AllforOne, BalanceConfig.keyblades.allForOne[0], BalanceConfig.keyblades.allForOne[1], Strings.guard, 5F),
            AnguisForetellersKeyblade = new ItemRealKeyblade(Strings.AnguisForetellersKeyblade, BalanceConfig.keyblades.anguisForetellersKeyblade[0], BalanceConfig.keyblades.anguisForetellersKeyblade[1], Strings.guard, 5F),
            AstralBlast = new ItemRealKeyblade(Strings.AstralBlast, BalanceConfig.keyblades.astralBlast[0], BalanceConfig.keyblades.astralBlast[1], Strings.guard, 5F),
            Aubade = new ItemRealKeyblade(Strings.Aubade, BalanceConfig.keyblades.aubade[0], BalanceConfig.keyblades.aubade[1], Strings.guard, 5F),
            BondofFlame = new ItemRealKeyblade(Strings.BondofFlame, BalanceConfig.keyblades.bondofFlame[0], BalanceConfig.keyblades.bondofFlame[1], Strings.fireBoost, 5F),
            Brightcrest = new ItemRealKeyblade(Strings.Brightcrest, BalanceConfig.keyblades.brightcrest[0], BalanceConfig.keyblades.brightcrest[1], Strings.guard, 5F),
            ChaosRipper = new ItemRealKeyblade(Strings.ChaosRipper, BalanceConfig.keyblades.chaosRipper[0], BalanceConfig.keyblades.chaosRipper[1], Strings.guard, 5F),
            CircleofLife = new ItemRealKeyblade(Strings.CircleofLife, BalanceConfig.keyblades.circleofLife[0], BalanceConfig.keyblades.circleofLife[1], Strings.mpHaste, 5F),
            Counterpoint = new ItemRealKeyblade(Strings.Counterpoint, BalanceConfig.keyblades.counterpoint[0], BalanceConfig.keyblades.counterpoint[1], Strings.guard, 5F),
            Crabclaw = new ItemRealKeyblade(Strings.Crabclaw, BalanceConfig.keyblades.crabclaw[0], BalanceConfig.keyblades.crabclaw[1], Strings.guard, 5F),
            CrownofGuilt = new ItemRealKeyblade(Strings.CrownofGuilt, BalanceConfig.keyblades.crownofGuilt[0], BalanceConfig.keyblades.crownofGuilt[1], Strings.guard, 5F),
            DarkerThanDark = new ItemRealKeyblade(Strings.DarkerThanDark, BalanceConfig.keyblades.darkerthanDark[0], BalanceConfig.keyblades.darkerthanDark[1], Strings.guard, 5F),
            Darkgnaw = new ItemRealKeyblade(Strings.Darkgnaw, BalanceConfig.keyblades.darkgnaw[0], BalanceConfig.keyblades.darkgnaw[1], Strings.guard, 5F),
            ...
            DestinysEmbrace = new ItemRealKeyblade(Strings.DestinysEmbrace, BalanceConfig.keyblades.destinysEmbrace[0], BalanceConfig.keyblades.destinysEmbrace[1], Strings.guard, 5F),
            DiamondDust = new ItemRealKeyblade(Strings.DiamondDust, BalanceConfig.keyblades.diamondDust[0], BalanceConfig.keyblades.diamondDust[1], Strings.guard, 5F),
            Divewing = new ItemRealKeyblade(Strings.Divewing, BalanceConfig.keyblades.divewing[0], BalanceConfig.keyblades.divewing[1], Strings.guard, 5F),
            DivineRose = new ItemRealKeyblade(Strings.DivineRose, BalanceConfig.keyblades.divineRose[0], BalanceConfig.keyblades.divineRose[1], Strings.guard, 5F),
            DreamStaff = new ItemKeyblade(Strings.DreamStaff, BalanceConfig.other.dreamStaff[0], BalanceConfig.other.dreamStaff[1], Strings.guard, 5F),
            DreamSword = new ItemKeyblade(Strings.DreamSword, BalanceConfig.other.dreamSword[0], BalanceConfig.other.dreamSword[1], Strings.guard, 5F),
            DualDisc = new ItemRealKeyblade(Strings.DualDisc, BalanceConfig.keyblades.dualDisc[0], BalanceConfig.keyblades.dualDisc[1], Strings.guard, 5F),
            Earthshaker = new ItemRealKeyblade(Strings.Earthshaker, BalanceConfig.keyblades.earthshaker[0], BalanceConfig.keyblades.earthshaker[1], Strings.guard, 5F),
            EndofPain = new ItemRealKeyblade(Strings.EndofPain, BalanceConfig.keyblades.endofPain[0], BalanceConfig.keyblades.endofPain[1], Strings.guard, 5F),
            EndsoftheEarth = new ItemRealKeyblade(Strings.EndsoftheEarth, BalanceConfig.keyblades.endsoftheEarth[0], BalanceConfig.keyblades.endsoftheEarth[1], Strings.guard, 5F),
            FairyHarp = new ItemRealKeyblade(Strings.FairyHarp, BalanceConfig.keyblades.fairyHarp[0], BalanceConfig.keyblades.fairyHarp[1], Strings.guard, 5F),
            FairyStars = new ItemRealKeyblade(Strings.FairyStars, BalanceConfig.keyblades.fairyStars[0], BalanceConfig.keyblades.fairyStars[1], Strings.guard, 5F),
            FatalCrest = new ItemRealKeyblade(Strings.FatalCrest, BalanceConfig.keyblades.fatalCrest[0], BalanceConfig.keyblades.fatalCrest[1], Strings.berserkCharge, 5F),
            Fenrir = new ItemRealKeyblade(Strings.Fenrir, BalanceConfig.keyblades.fenrir[0], BalanceConfig.keyblades.fenrir[1], Strings.negativeCombo, 5F),
            FerrisGear = new ItemRealKeyblade(Strings.FerrisGear, BalanceConfig.keyblades.ferrisGear[0], BalanceConfig.keyblades.ferrisGear[1], Strings.guard, 5F),
            FollowtheWind = new ItemRealKeyblade(Strings.FollowtheWind, BalanceConfig.keyblades.followtheWind[0], BalanceConfig.keyblades.followtheWind[1], Strings.draw, 5F),
            FrolicFlame = new ItemRealKeyblade(Strings.FrolicFlame, BalanceConfig.keyblades.frolicFlame[0], BalanceConfig.keyblades.frolicFlame[1], Strings.guard, 5F),
            GlimpseofDarkness = new ItemRealKeyblade(Strings.GlimpseofDarkness, BalanceConfig.keyblades.glimpseofDarkness[0], BalanceConfig.keyblades.glimpseofDarkness[1], Strings.guard, 5F),
            GuardianBell = new ItemRealKeyblade(Strings.GuardianBell, BalanceConfig.keyblades.guardianBell[0], BalanceConfig.keyblades.guardianBell[1], Strings.guard, 5F),
            GuardianSoul = new ItemRealKeyblade(Strings.GuardianSoul, BalanceConfig.keyblades.guardianSoul[0], BalanceConfig.keyblades.guardianSoul[1], Strings.reactionBoost, 5F),
            GullWing = new ItemRealKeyblade(Strings.GullWing, BalanceConfig.keyblades.gullWing[0], BalanceConfig.keyblades.gullWing[1], Strings.experienceBoost, 5F),
            HerosCrest = new ItemRealKeyblade(Strings.HerosCrest, BalanceConfig.keyblades.herosCrest[0], BalanceConfig.keyblades.herosCrest[1], Strings.airComboBoost, 5F),
            HiddenDragon = new ItemRealKeyblade(Strings.HiddenDragon, BalanceConfig.keyblades.hiddenDragon[0], BalanceConfig.keyblades.hiddenDragon[1], Strings.mpRage, 5F ),
            Hyperdrive = new ItemRealKeyblade(Strings.Hyperdrive, BalanceConfig.keyblades.hyperdrive[0], BalanceConfig.keyblades.hyperdrive[1], Strings.guard, 5F),
            IncompleteKiblade = new ItemRealKeyblade(Strings.IncompleteKiblade, BalanceConfig.keyblades.incompletexblade[0], BalanceConfig.keyblades.incompletexblade[1], Strings.guard, 5F),
            JungleKing = new ItemRealKeyblade(Strings.JungleKing, BalanceConfig.keyblades.jungleKing[0], BalanceConfig.keyblades.jungleKing[1], Strings.guard, 5F),
            KeybladeofPeoplesHearts = new ItemRealKeyblade(Strings.KeybladeofPeoplesHearts, BalanceConfig.keyblades.keybladeofPeoplesHearts[0], BalanceConfig.keyblades.keybladeofPeoplesHearts[1], Strings.guard, 5F),
            Kiblade = new ItemRealKeyblade(Strings.Kiblade, BalanceConfig.keyblades.xblade[0], BalanceConfig.keyblades.xblade[1], Strings.guard, 5F),
            KingdomKey = new ItemRealKeyblade(Strings.KingdomKey, BalanceConfig.keyblades.kingdomKey[0], BalanceConfig.keyblades.kingdomKey[1], Strings.damageControl,  5F),
            KingdomKeyD = new ItemRealKeyblade(Strings.KingdomKeyD, BalanceConfig.keyblades.kingdomKeyD[0], BalanceConfig.keyblades.kingdomKeyD[1], Strings.guard, 5F),
            KnockoutPunch = new ItemRealKeyblade(Strings.KnockoutPunch, BalanceConfig.keyblades.knockoutPunch[0], BalanceConfig.keyblades.knockoutPunch[1], Strings.guard, 5F),
            ...
            MarkofaHero = new ItemRealKeyblade(Strings.MarkofaHero, BalanceConfig.keyblades.markofaHero[0], BalanceConfig.keyblades.markofaHero[1], Strings.guard, 5F),
            MasterXehanortsKeyblade = new ItemRealKeyblade(Strings.MasterXehanortsKeyblade, BalanceConfig.keyblades.masterXehanortsKeyblade[0], BalanceConfig.keyblades.masterXehanortsKeyblade[1], Strings.guard, 5F),
            MastersDefender = new ItemRealKeyblade(Strings.MastersDefender, BalanceConfig.keyblades.mastersDefender[0], BalanceConfig.keyblades.mastersDefender[1], Strings.guard, 5F),
            MaverickFlare = new ItemRealKeyblade(Strings.MaverickFlare, BalanceConfig.keyblades.maverickFlare[0], BalanceConfig.keyblades.maverickFlare[1], Strings.guard, 5F),
            MetalChocobo = new ItemRealKeyblade(Strings.MetalChocobo, BalanceConfig.keyblades.metalChocobo[0], BalanceConfig.keyblades.metalChocobo[1], Strings.guard, 5F),
            ...
            NightmaresEndandMirageSplit = new ItemRealKeyblade(Strings.NightmaresEndandMirageSplit, BalanceConfig.keyblades.combinedKeyblade[0], BalanceConfig.keyblades.combinedKeyblade[1], Strings.guard, 5F),
            NoName = new ItemRealKeyblade(Strings.NoName, BalanceConfig.keyblades.noName[0], BalanceConfig.keyblades.noName[1], Strings.guard, 5F),
            Oathkeeper = new ItemRealKeyblade(Strings.Oathkeeper, BalanceConfig.keyblades.oathkeeper[0], BalanceConfig.keyblades.oathkeeper[1], Strings.formBoost),
            Oblivion = new ItemRealKeyblade(Strings.Oblivion, BalanceConfig.keyblades.oblivion[0], BalanceConfig.keyblades.oblivion[1], Strings.driveBoost),
            OceansRage = new ItemRealKeyblade(Strings.OceansRage, BalanceConfig.keyblades.oceansRage[0], BalanceConfig.keyblades.oceansRage[1], Strings.guard, 5F),
            Olympia = new ItemRealKeyblade(Strings.Olympia, BalanceConfig.keyblades.olympia[0], BalanceConfig.keyblades.olympia[1], Strings.guard, 5F),
            OmegaWeapon = new ItemRealKeyblade(Strings.OmegaWeapon, BalanceConfig.keyblades.omegaWeapon[0], BalanceConfig.keyblades.omegaWeapon[1], Strings.guard, 5F),
            OminousBlight = new ItemRealKeyblade(Strings.OminousBlight, BalanceConfig.keyblades.ominousBlight[0], BalanceConfig.keyblades.ominousBlight[1], Strings.guard, 5F),
            OneWingedAngel = new ItemRealKeyblade(Strings.OneWingedAngel, BalanceConfig.keyblades.oneWingedAngel[0], BalanceConfig.keyblades.oneWingedAngel[1], Strings.guard, 5F),
            PainofSolitude = new ItemRealKeyblade(Strings.PainofSolitude, BalanceConfig.keyblades.painofSolitude[0], BalanceConfig.keyblades.painofSolitude[1], Strings.guard, 5F),
            PhotonDebugger = new ItemRealKeyblade(Strings.PhotonDebugger, BalanceConfig.keyblades.photonDebugger[0], BalanceConfig.keyblades.photonDebugger[1], Strings.thunderBoost, 5F),
            PixiePetal = new ItemRealKeyblade(Strings.PixiePetal, BalanceConfig.keyblades.pixiePetal[0], BalanceConfig.keyblades.pixiePetal[1], Strings.guard, 5F),
            Pumpkinhead = new ItemRealKeyblade(Strings.Pumpkinhead, BalanceConfig.keyblades.pumpkinhead[0], BalanceConfig.keyblades.pumpkinhead[1], Strings.guard, 5F),
            Rainfell = new ItemRealKeyblade(Strings.Rainfell, BalanceConfig.keyblades.rainfell[0], BalanceConfig.keyblades.rainfell[1], Strings.guard, 5F),
            ...
            SleepingLion = new ItemRealKeyblade(Strings.SleepingLion, BalanceConfig.keyblades.sleepingLion[0], BalanceConfig.keyblades.sleepingLion[1], Strings.comboPlus, 5F),
            SoulEater = new ItemRealKeyblade(Strings.SoulEater, BalanceConfig.keyblades.soulEater[0], BalanceConfig.keyblades.soulEater[1], Strings.guard, 5F),
            Spellbinder = new ItemRealKeyblade(Strings.Spellbinder, BalanceConfig.keyblades.spellbinder[0], BalanceConfig.keyblades.spellbinder[1], Strings.guard, 5F),
            Starlight = new ItemRealKeyblade(Strings.Starlight, BalanceConfig.keyblades.starlight[0], BalanceConfig.keyblades.starlight[1], Strings.guard, 5F),
            StarSeeker = new ItemRealKeyblade(Strings.StarSeeker, BalanceConfig.keyblades.starSeeker[0], BalanceConfig.keyblades.starSeeker[1], Strings.airComboPlus, 5F),
            Stormfall = new ItemRealKeyblade(Strings.Stormfall, BalanceConfig.keyblades.stormfall[0], BalanceConfig.keyblades.stormfall[1], Strings.guard, 5F),
            StrokeofMidnight = new ItemRealKeyblade(Strings.StrokeofMidnight, BalanceConfig.keyblades.strokeofMidnight[0], BalanceConfig.keyblades.strokeofMidnight[1], Strings.guard, 5F),
            SweetDreams = new ItemRealKeyblade(Strings.SweetDreams, BalanceConfig.keyblades.sweetDreams[0], BalanceConfig.keyblades.sweetDreams[1], Strings.guard, 5F),
            SweetMemories = new ItemRealKeyblade(Strings.SweetMemories, BalanceConfig.keyblades.sweetMemories[0], BalanceConfig.keyblades.sweetMemories[1], Strings.driveConverter, 5F),
            Sweetstack = new ItemRealKeyblade(Strings.Sweetstack, BalanceConfig.keyblades.sweetstack[0], BalanceConfig.keyblades.sweetstack[1], Strings.guard, 5F),
            ThreeWishes = new ItemRealKeyblade(Strings.ThreeWishes, BalanceConfig.keyblades.threeWishes[0], BalanceConfig.keyblades.threeWishes[1], Strings.guard, 5F),
            TotalEclipse = new ItemRealKeyblade(Strings.TotalEclipse, BalanceConfig.keyblades.totalEclipse[0], BalanceConfig.keyblades.totalEclipse[1], Strings.guard, 5F),
            TreasureTrove = new ItemRealKeyblade(Strings.TreasureTrove, BalanceConfig.keyblades.treasureTrove[0], BalanceConfig.keyblades.treasureTrove[1], Strings.guard, 5F),
            TrueLightsFlight = new ItemRealKeyblade(Strings.TrueLightsFlight, BalanceConfig.keyblades.trueLightsFlight[0], BalanceConfig.keyblades.trueLightsFlight[1], Strings.guard, 5F),
            TwilightBlaze = new ItemRealKeyblade(Strings.TwilightBlaze, BalanceConfig.keyblades.twilightBlaze[0], BalanceConfig.keyblades.twilightBlaze[1], Strings.guard, 5F),
            ...
            Unbound = new ItemRealKeyblade(Strings.Unbound, BalanceConfig.keyblades.unbound[0], BalanceConfig.keyblades.unbound[1], Strings.guard, 5F),
            UnicornisForetellersKeyblade = new ItemRealKeyblade(Strings.UnicornisForetellersKeyblade, BalanceConfig.keyblades.unicornisForetellersKeyblade[0], BalanceConfig.keyblades.unicornisForetellersKeyblade[1], Strings.guard, 5F),
            UrsusForetellersKeyblade = new ItemRealKeyblade(Strings.UrsusForetellersKeyblade, BalanceConfig.keyblades.ursusForetellersKeyblade[0], BalanceConfig.keyblades.ursusForetellersKeyblade[1], Strings.guard, 5F),
            VictoryLine = new ItemRealKeyblade(Strings.VictoryLine, BalanceConfig.keyblades.victoryLine[0], BalanceConfig.keyblades.victoryLine[1], Strings.guard, 5F),
            VoidGear = new ItemRealKeyblade(Strings.VoidGear, BalanceConfig.keyblades.voidGear[0], BalanceConfig.keyblades.voidGear[1], Strings.guard, 5F),
            VulpeusForetellersKeyblade = new ItemRealKeyblade(Strings.VulpeusForetellersKeyblade, BalanceConfig.keyblades.vulpeusForetellersKeyblade[0], BalanceConfig.keyblades.vulpeusForetellersKeyblade[1], Strings.guard, 5F),
            WaytotheDawn = new ItemRealKeyblade(Strings.WaytotheDawn, BalanceConfig.keyblades.waytotheDawn[0], BalanceConfig.keyblades.waytotheDawn[1], Strings.guard, 5F),
            WaywardWind = new ItemRealKeyblade(Strings.WaywardWind, BalanceConfig.keyblades.waywardWind[0], BalanceConfig.keyblades.waywardWind[1], Strings.guard, 5F),
            WinnersProof = new ItemRealKeyblade(Strings.WinnersProof, BalanceConfig.keyblades.winnersProof[0], BalanceConfig.keyblades.winnersProof[1], Strings.zeroEXP, 5F),
            WishingLamp = new ItemRealKeyblade(Strings.WishingLamp, BalanceConfig.keyblades.wishingLamp[0], BalanceConfig.keyblades.wishingLamp[1], Strings.jackpot, 5F),
            WishingStar = new ItemRealKeyblade(Strings.WishingStar, BalanceConfig.keyblades.wishingStar[0], BalanceConfig.keyblades.wishingStar[1], Strings.guard, 5F),
            WoodenKeyblade = new ItemKeyblade(Strings.WoodenKeyblade, BalanceConfig.keyblades.woodenKeyblade[0], BalanceConfig.keyblades.woodenKeyblade[1], Strings.guard, 5F),
            WoodenStick = new ItemKeyblade(Strings.WoodenStick, BalanceConfig.keyblades.woodenStick[0], BalanceConfig.keyblades.woodenStick[1], Strings.guard, 5F),
            YoungXehanortsKeyblade = new ItemRealKeyblade(Strings.YoungXehanortsKeyblade, BalanceConfig.keyblades.youngXehanortsKeyblade[0], BalanceConfig.keyblades.youngXehanortsKeyblade[1], Strings.guard, 5F),
            ZeroOne = new ItemRealKeyblade(Strings.ZeroOne, BalanceConfig.keyblades.zeroOne[0], BalanceConfig.keyblades.zeroOne[1], Strings.guard, 5F),
