...
public class ModItems {
	...
	public static void init () {
		...
		AbaddonPlasma = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.AbaddonPlasma);
		AbyssalTide = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.AbyssalTide);
		AllforOne = new ItemRealKeyblade(30* ConfigHandler.damageMultiplier,24* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.AllforOne);
		AnguisForetellersKeyblade = new ItemRealKeyblade(13* ConfigHandler.damageMultiplier, 8* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.AnguisForetellersKeyblade);
		AstralBlast = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.AstralBlast);
		Aubade = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Aubade);
		BondofFlame = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier,8* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.BondofFlame);
		Brightcrest = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier, 14* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Brightcrest);
		ChaosRipper = new ItemRealKeyblade(30* ConfigHandler.damageMultiplier,4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.ChaosRipper);
		CircleofLife = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.CircleofLife);
		Counterpoint = new ItemRealKeyblade(36* ConfigHandler.damageMultiplier,28* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Counterpoint);
		Crabclaw = new ItemRealKeyblade(18* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Crabclaw);
		CrownofGuilt = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier, 6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.CrownofGuilt);
		DarkerThanDark = new ItemRealKeyblade(48* ConfigHandler.damageMultiplier, 8* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.DarkerThanDark);
		Darkgnaw = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier,4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Darkgnaw);
		DecisivePumpkin = new ItemRealKeyblade(18* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.DecisivePumpkin);
		DestinysEmbrace = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.DestinysEmbrace);
		DiamondDust = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.DiamondDust);
		Divewing = new ItemRealKeyblade(36* ConfigHandler.damageMultiplier,30* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Divewing);
		DivineRose = new ItemRealKeyblade(30* ConfigHandler.damageMultiplier,0* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.DivineRose);
		DreamSword = new ItemKeyblade(1* ConfigHandler.damageMultiplier, 1* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.DreamSword);
		DualDisc = new ItemRealKeyblade(30* ConfigHandler.damageMultiplier,14* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.DualDisc);
		Earthshaker = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Earthshaker);
		EndofPain = new ItemRealKeyblade(21* ConfigHandler.damageMultiplier,16* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.EndofPain);
		EndsoftheEarth = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier,6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.EndsoftheEarth);
		FairyHarp = new ItemRealKeyblade(24* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.FairyHarp);
		FairyStars = new ItemRealKeyblade(6* ConfigHandler.damageMultiplier,6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.FairyStars);
		FatalCrest = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,10* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.FatalCrest);
		Fenrir = new ItemRealKeyblade(21* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Fenrir);
		FerrisGear = new ItemRealKeyblade(24* ConfigHandler.damageMultiplier,16* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.FerrisGear);
		FollowtheWind = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.FollowtheWind);
		FrolicFlame = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier, 6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.FrolicFlame);
		GlimpseofDarkness = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.GlimpseofDarkness);
		GuardianBell = new ItemRealKeyblade(21* ConfigHandler.damageMultiplier,20* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.GuardianBell);
		GuardianSoul = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.GuardianSoul);
		GullWing = new ItemRealKeyblade(6* ConfigHandler.damageMultiplier,6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.GullWing);
		HerosCrest = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier,0* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.HerosCrest);
		HiddenDragon = new ItemRealKeyblade(6* ConfigHandler.damageMultiplier,4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.HiddenDragon);
		Hyperdrive = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier,6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Hyperdrive);
		IncompleteKiblade = new ItemRealKeyblade(18* ConfigHandler.damageMultiplier,6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.IncompleteKiblade);
		JungleKing = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier,0* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.JungleKing);
		KeybladeofPeoplesHearts = new ItemRealKeyblade(24* ConfigHandler.damageMultiplier, 12* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.KeybladeofPeoplesHearts);
		Kiblade = new ItemRealKeyblade(54* ConfigHandler.damageMultiplier,30* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Kiblade);
		KingdomKey = new ItemRealKeyblade(3* ConfigHandler.damageMultiplier,1* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.KingdomKey);
		((ItemKeyblade)KingdomKey).setDescription("The key chain attached draws out the Keyblade's true form and power.");
		KingdomKeyD = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.KingdomKeyD);
		KnockoutPunch = new ItemRealKeyblade(36* ConfigHandler.damageMultiplier,20* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.KnockoutPunch);
		LadyLuck = new ItemRealKeyblade(24* ConfigHandler.damageMultiplier,4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.LadyLuck);
		LeasKeyblade = new ItemRealKeyblade(18* ConfigHandler.damageMultiplier, 20* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.LeasKeyblade);
		LeopardosForetellersKeyblade = new ItemRealKeyblade(21* ConfigHandler.damageMultiplier, 7* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.LeopardosForetellersKeyblade);
		Leviathan = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Leviathan);
		Lionheart = new ItemRealKeyblade(30* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Lionheart);
		LostMemory = new ItemRealKeyblade(18* ConfigHandler.damageMultiplier,10* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.LostMemory);
		LunarEclipse = new ItemRealKeyblade(18* ConfigHandler.damageMultiplier, 6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.LunarEclipse);
		MarkofaHero = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.MarkofaHero);
		MasterXehanortsKeyblade = new ItemRealKeyblade(51* ConfigHandler.damageMultiplier, 20* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.MasterXehanortsKeyblade);
		MastersDefender = new ItemRealKeyblade(45* ConfigHandler.damageMultiplier, 24* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.MastersDefender);
		MaverickFlare = new ItemRealKeyblade(21* ConfigHandler.damageMultiplier, 8* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.MaverickFlare);
		MetalChocobo = new ItemRealKeyblade(30* ConfigHandler.damageMultiplier,-2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.MetalChocobo);
		MidnightRoar = new ItemRealKeyblade(24* ConfigHandler.damageMultiplier, 4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.MidnightRoar);
		MirageSplit = new ItemRealKeyblade(42* ConfigHandler.damageMultiplier, 16* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.MirageSplit);
		MissingAche = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier, 0* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.MissingAche);
		Monochrome = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Monochrome);
		MysteriousAbyss = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.MysteriousAbyss);
		NightmaresEnd = new ItemRealKeyblade(42* ConfigHandler.damageMultiplier, 16* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.NightmaresEnd);
		NightmaresEndandMirageSplit = new ItemRealKeyblade(60* ConfigHandler.damageMultiplier, 24* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.NightmaresEndandMirageSplit);
		NoName = new ItemRealKeyblade(18* ConfigHandler.damageMultiplier,14* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.NoName);
		Oathkeeper = new ItemRealKeyblade(18* ConfigHandler.damageMultiplier,6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Oathkeeper);
		Oblivion = new ItemRealKeyblade(21* ConfigHandler.damageMultiplier,4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Oblivion);
		OceansRage = new ItemRealKeyblade(24* ConfigHandler.damageMultiplier,20* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.OceansRage);
		Olympia = new ItemRealKeyblade(27* ConfigHandler.damageMultiplier,0* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Olympia);
		OmegaWeapon = new ItemRealKeyblade(18* ConfigHandler.damageMultiplier, 6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.OmegaWeapon);
		OminousBlight = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.OminousBlight);
		OneWingedAngel = new ItemRealKeyblade(24* ConfigHandler.damageMultiplier,-4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.OneWingedAngel);
		PainofSolitude = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier, 4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.PainofSolitude);
		PhotonDebugger = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.PhotonDebugger);
		PixiePetal = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,12* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.PixiePetal);
		Pumpkinhead = new ItemRealKeyblade(21* ConfigHandler.damageMultiplier,0* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Pumpkinhead);
		Rainfell = new ItemRealKeyblade(6* ConfigHandler.damageMultiplier,4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Rainfell);
		RejectionofFate = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.RejectionofFate);
		RoyalRadiance = new ItemRealKeyblade(24* ConfigHandler.damageMultiplier,14* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.RoyalRadiance);
		RumblingRose = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier,0* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.RumblingRose);
		SignofInnocence = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier, 4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.SignofInnocence);
		SilentDirge = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier, 6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.SilentDirge);
		SkullNoise = new ItemRealKeyblade(21* ConfigHandler.damageMultiplier,14* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.SkullNoise);
		SleepingLion = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier,6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.SleepingLion);
		SoulEater = new ItemRealKeyblade(39* ConfigHandler.damageMultiplier, 6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.SoulEater);
		Spellbinder = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier,4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Spellbinder);
		Starlight = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Starlight);
		StarSeeker = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.StarSeeker);
		Stormfall = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier, 8* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Stormfall);
		StrokeofMidnight = new ItemRealKeyblade(6* ConfigHandler.damageMultiplier,4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.StrokeofMidnight);
		SweetDreams = new ItemRealKeyblade(21* ConfigHandler.damageMultiplier,24* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.SweetDreams);
		SweetMemories = new ItemRealKeyblade(3* ConfigHandler.damageMultiplier, 8* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.SweetMemories);
		Sweetstack = new ItemRealKeyblade(18* ConfigHandler.damageMultiplier,8* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Sweetstack);
		ThreeWishes = new ItemRealKeyblade(18* ConfigHandler.damageMultiplier,0* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.ThreeWishes);
		TotalEclipse = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.TotalEclipse);
		TreasureTrove = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.TreasureTrove);
		TrueLightsFlight = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.TrueLightsFlight);
		TwilightBlaze = new ItemRealKeyblade(21* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.TwilightBlaze);
		TwoBecomeOne = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier,8* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.TwoBecomeOne);
		UltimaWeaponKH1 = new ItemRealKeyblade(36* ConfigHandler.damageMultiplier,20* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.UltimaWeaponKH1);
		UltimaWeaponKH2 = new ItemRealKeyblade(36* ConfigHandler.damageMultiplier,20* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.UltimaWeaponKH2);
		UltimaWeaponBBS = new ItemRealKeyblade(36* ConfigHandler.damageMultiplier,20* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.UltimaWeaponBBS);
		UltimaWeaponDDD = new ItemRealKeyblade(36* ConfigHandler.damageMultiplier,20* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.UltimaWeaponDDD);
		Umbrella = new ItemKeyblade(9* ConfigHandler.damageMultiplier, 2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Umbrella);
		Unbound = new ItemRealKeyblade(27* ConfigHandler.damageMultiplier,28* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.Unbound);
		UnicornisForetellersKeyblade = new ItemRealKeyblade(19* ConfigHandler.damageMultiplier, 7* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.UnicornisForetellersKeyblade);
		UrsusForetellersKeyblade = new ItemRealKeyblade(22* ConfigHandler.damageMultiplier, 4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.UrsusForetellersKeyblade);
		VictoryLine = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier,4* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.VictoryLine);
		VoidGear = new ItemRealKeyblade(24* ConfigHandler.damageMultiplier,8* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.VoidGear);
		VulpeusForetellersKeyblade = new ItemRealKeyblade(20* ConfigHandler.damageMultiplier, 5* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.VulpeusForetellersKeyblade);
		WaytotheDawn = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier,8* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.WaytotheDawn);
		WaywardWind = new ItemRealKeyblade(9* ConfigHandler.damageMultiplier,2* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.WaywardWind);
		WinnersProof = new ItemRealKeyblade(15* ConfigHandler.damageMultiplier,14* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.WinnersProof);
		WishingLamp = new ItemRealKeyblade(12* ConfigHandler.damageMultiplier,6* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.WishingLamp);
		WishingStar = new ItemRealKeyblade(18* ConfigHandler.damageMultiplier,0* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.WishingStar);
		WoodenKeyblade = new ItemKeyblade(6* ConfigHandler.damageMultiplier, 0* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.WoodenKeyblade);
		WoodenStick = new ItemKeyblade(0* ConfigHandler.damageMultiplier, 0* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.WoodenStick);
		YoungXehanortsKeyblade = new ItemRealKeyblade(45* ConfigHandler.damageMultiplier,16* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.YoungXehanortsKeyblade);
		ZeroOne = new ItemRealKeyblade(33* ConfigHandler.damageMultiplier,12* ConfigHandler.damageMultiplier).setUnlocalizedName(Strings.ZeroOne);
