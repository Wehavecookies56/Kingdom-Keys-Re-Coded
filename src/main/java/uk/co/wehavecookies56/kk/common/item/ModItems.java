...
public class ModItems {
	...
	public static void init () {
		...
		AbaddonPlasma = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.AbaddonPlasma);
		AbyssalTide = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.AbyssalTide);
		AllforOne = new ItemRealKeyblade(30,24).setUnlocalizedName(Strings.AllforOne);
		AnguisForetellersKeyblade = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.AnguisForetellersKeyblade);
		AstralBlast = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.AstralBlast);
		Aubade = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Aubade);
		BondofFlame = new ItemRealKeyblade(12,8).setUnlocalizedName(Strings.BondofFlame);
		Brightcrest = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Brightcrest);
		ChaosRipper = new ItemRealKeyblade(30,4).setUnlocalizedName(Strings.ChaosRipper);
		CircleofLife = new ItemRealKeyblade(12,2).setUnlocalizedName(Strings.CircleofLife);
		Counterpoint = new ItemRealKeyblade(36,28).setUnlocalizedName(Strings.Counterpoint);
		Crabclaw = new ItemRealKeyblade(18,2).setUnlocalizedName(Strings.Crabclaw);
		CrownofGuilt = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.CrownofGuilt);
		DarkerThanDark = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.DarkerThanDark);
		Darkgnaw = new ItemRealKeyblade(15,4).setUnlocalizedName(Strings.Darkgnaw);
		DecisivePumpkin = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.DecisivePumpkin);
		DestinysEmbrace = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.DestinysEmbrace);
		...
		DualDisc = new ItemRealKeyblade(30,14).setUnlocalizedName(Strings.DualDisc);
		Earthshaker = new ItemRealKeyblade(9,2).setUnlocalizedName(Strings.Earthshaker);
		EndofPain = new ItemRealKeyblade(21,16).setUnlocalizedName(Strings.EndofPain);
		EndsoftheEarth = new ItemRealKeyblade(15,6).setUnlocalizedName(Strings.EndsoftheEarth);
		FairyHarp = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.FairyHarp);
		FairyStars = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.FairyStars);
		FatalCrest = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.FatalCrest);
		Fenrir = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Fenrir);
		FerrisGear = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.FerrisGear);
		FollowtheWind = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.FollowtheWind);
		FrolicFlame = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.FrolicFlame);
		GlimpseofDarkness = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.GlimpseofDarkness);
		GuardianBell = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.GuardianBell);
		GuardianSoul = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.GuardianSoul);
		GullWing = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.GullWing);
		HerosCrest = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.HerosCrest);
		HiddenDragon = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.HiddenDragon);
		Hyperdrive = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Hyperdrive);
		IncompleteKiblade = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.IncompleteKiblade);
		JungleKing = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.JungleKing);
		KeybladeofPeoplesHearts = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.KeybladeofPeoplesHearts);
		Kiblade = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Kiblade);
		KingdomKey = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.KingdomKey);
		KingdomKeyD = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.KingdomKeyD);
		KnockoutPunch = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.KnockoutPunch);
		LadyLuck = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.LadyLuck);
		LeasKeyblade = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.LeasKeyblade);
		LeopardosForetellersKeyblade = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.LeopardosForetellersKeyblade);
		Leviathan = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Leviathan);
		Lionheart = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Lionheart);
		LostMemory = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.LostMemory);
		LunarEclipse = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.LunarEclipse);
		MarkofaHero = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.MarkofaHero);
		MasterXehanortsKeyblade = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.MasterXehanortsKeyblade);
		MastersDefender = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.MastersDefender);
		MaverickFlare = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.MaverickFlare);
		MetalChocobo = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.MetalChocobo);
		MidnightRoar = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.MidnightRoar);
		MirageSplit = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.MirageSplit);
		MissingAche = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.MissingAche);
		Monochrome = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Monochrome);
		MysteriousAbyss = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.MysteriousAbyss);
		NightmaresEnd = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.NightmaresEnd);
		NightmaresEndandMirageSplit = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.NightmaresEndandMirageSplit);
		NoName = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.NoName);
		Oathkeeper = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Oathkeeper);
		Oblivion = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Oblivion);
		OceansRage = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.OceansRage);
		Olympia = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Olympia);
		OmegaWeapon = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.OmegaWeapon);
		OminousBlight = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.OminousBlight);
		OneWingedAngel = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.OneWingedAngel);
		PainofSolitude = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.PainofSolitude);
		PhotonDebugger = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.PhotonDebugger);
		PixiePetal = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.PixiePetal);
		Pumpkinhead = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Pumpkinhead);
		Rainfell = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Rainfell);
		RejectionofFate = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.RejectionofFate);
		RoyalRadiance = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.RoyalRadiance);
		RumblingRose = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.RumblingRose);
		SignofInnocence = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.SignofInnocence);
		SilentDirge = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.SilentDirge);
		SkullNoise = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.SkullNoise);
		SleepingLion = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.SleepingLion);
		SoulEater = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.SoulEater);
		Spellbinder = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Spellbinder);
		Starlight = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Starlight);
		StarSeeker = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.StarSeeker);
		Stormfall = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Stormfall);
		StrokeofMidnight = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.StrokeofMidnight);
		SweetDreams = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.SweetDreams);
		SweetMemories = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.SweetMemories);
		Sweetstack = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Sweetstack);
		ThreeWishes = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.ThreeWishes);
		TotalEclipse = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.TotalEclipse);
		TreasureTrove = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.TreasureTrove);
		TrueLightsFlight = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.TrueLightsFlight);
		TwilightBlaze = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.TwilightBlaze);
		TwoBecomeOne = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.TwoBecomeOne);
		UltimaWeaponKH1 = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.UltimaWeaponKH1);
		UltimaWeaponKH2 = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.UltimaWeaponKH2);
		UltimaWeaponBBS = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.UltimaWeaponBBS);
		UltimaWeaponDDD = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.UltimaWeaponDDD);
		Umbrella = new ItemKeyblade(KEYBLADE).setUnlocalizedName(Strings.Umbrella);
		Unbound = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.Unbound);
		UnicornisForetellersKeyblade = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.UnicornisForetellersKeyblade);
		UrsusForetellersKeyblade = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.UrsusForetellersKeyblade);
		VictoryLine = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.VictoryLine);
		VoidGear = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.VoidGear);
		VulpeusForetellersKeyblade = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.VulpeusForetellersKeyblade);
		WaytotheDawn = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.WaytotheDawn);
		WaywardWind = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.WaywardWind);
		WinnersProof = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.WinnersProof);
		WishingLamp = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.WishingLamp);
		WishingStar = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.WishingStar);
		WoodenKeyblade = new ItemKeyblade(KEYBLADE).setUnlocalizedName(Strings.WoodenKeyblade);
		WoodenStick = new ItemKeyblade(KEYBLADE).setUnlocalizedName(Strings.WoodenStick);
		YoungXehanortsKeyblade = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.YoungXehanortsKeyblade);
		ZeroOne = new ItemRealKeyblade(KEYBLADE).setUnlocalizedName(Strings.ZeroOne);
