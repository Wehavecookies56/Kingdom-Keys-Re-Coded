...
public class ModItems {
	...
	public static ToolMaterial KEYBLADE = EnumHelper.addToolMaterial("KEYBLADE", 0, -1, 0, 0, 20);
	...
	public static void init () {
		...
		AbaddonPlasma = new ItemRealKeyblade(KEYBLADE,5,5).setUnlocalizedName(Strings.AbaddonPlasma);
		AbyssalTide = new ItemRealKeyblade(KEYBLADE,20,5).setUnlocalizedName(Strings.AbyssalTide);
		AllforOne = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.AllforOne);
		AnguisForetellersKeyblade = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.AnguisForetellersKeyblade);
		AstralBlast = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.AstralBlast);
		Aubade = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Aubade);
		BondofFlame = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.BondofFlame);
		Brightcrest = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Brightcrest);
		ChaosRipper = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.ChaosRipper);
		CircleofLife = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.CircleofLife);
		Counterpoint = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Counterpoint);
		Crabclaw = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Crabclaw);
		CrownofGuilt = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.CrownofGuilt);
		DarkerThanDark = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.DarkerThanDark);
		Darkgnaw = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Darkgnaw);
		DecisivePumpkin = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.DecisivePumpkin);
		DestinysEmbrace = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.DestinysEmbrace);
		DiamondDust = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.DiamondDust);
		Divewing = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Divewing);
		DivineRose = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.DivineRose);
		DreamSword = new ItemKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.DreamSword);
		DualDisc = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.DualDisc);
		Earthshaker = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Earthshaker);
		EndofPain = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.EndofPain);
		EndsoftheEarth = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.EndsoftheEarth);
		FairyHarp = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.FairyHarp);
		FairyStars = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.FairyStars);
		FatalCrest = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.FatalCrest);
		Fenrir = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Fenrir);
		FerrisGear = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.FerrisGear);
		FollowtheWind = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.FollowtheWind);
		FrolicFlame = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.FrolicFlame);
		GlimpseofDarkness = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.GlimpseofDarkness);
		GuardianBell = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.GuardianBell);
		GuardianSoul = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.GuardianSoul);
		GullWing = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.GullWing);
		HerosCrest = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.HerosCrest);
		HiddenDragon = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.HiddenDragon);
		Hyperdrive = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Hyperdrive);
		IncompleteKiblade = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.IncompleteKiblade);
		JungleKing = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.JungleKing);
		KeybladeofPeoplesHearts = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.KeybladeofPeoplesHearts);
		Kiblade = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Kiblade);
		KingdomKey = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.KingdomKey);
		KingdomKeyD = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.KingdomKeyD);
		KnockoutPunch = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.KnockoutPunch);
		LadyLuck = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.LadyLuck);
		LeasKeyblade = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.LeasKeyblade);
		LeopardosForetellersKeyblade = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.LeopardosForetellersKeyblade);
		Leviathan = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Leviathan);
		Lionheart = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Lionheart);
		LostMemory = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.LostMemory);
		LunarEclipse = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.LunarEclipse);
		MarkofaHero = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.MarkofaHero);
		MasterXehanortsKeyblade = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.MasterXehanortsKeyblade);
		MastersDefender = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.MastersDefender);
		MaverickFlare = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.MaverickFlare);
		MetalChocobo = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.MetalChocobo);
		MidnightRoar = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.MidnightRoar);
		MirageSplit = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.MirageSplit);
		MissingAche = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.MissingAche);
		Monochrome = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Monochrome);
		MysteriousAbyss = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.MysteriousAbyss);
		NightmaresEnd = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.NightmaresEnd);
		NightmaresEndandMirageSplit = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.NightmaresEndandMirageSplit);
		NoName = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.NoName);
		Oathkeeper = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Oathkeeper);
		Oblivion = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Oblivion);
		OceansRage = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.OceansRage);
		Olympia = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Olympia);
		OmegaWeapon = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.OmegaWeapon);
		OminousBlight = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.OminousBlight);
		OneWingedAngel = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.OneWingedAngel);
		PainofSolitude = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.PainofSolitude);
		PhotonDebugger = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.PhotonDebugger);
		PixiePetal = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.PixiePetal);
		Pumpkinhead = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Pumpkinhead);
		Rainfell = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Rainfell);
		RejectionofFate = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.RejectionofFate);
		RoyalRadiance = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.RoyalRadiance);
		RumblingRose = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.RumblingRose);
		SignofInnocence = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.SignofInnocence);
		SilentDirge = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.SilentDirge);
		SkullNoise = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.SkullNoise);
		SleepingLion = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.SleepingLion);
		SoulEater = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.SoulEater);
		Spellbinder = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Spellbinder);
		Starlight = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Starlight);
		StarSeeker = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.StarSeeker);
		Stormfall = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Stormfall);
		StrokeofMidnight = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.StrokeofMidnight);
		SweetDreams = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.SweetDreams);
		SweetMemories = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.SweetMemories);
		Sweetstack = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Sweetstack);
		ThreeWishes = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.ThreeWishes);
		TotalEclipse = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.TotalEclipse);
		TreasureTrove = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.TreasureTrove);
		TrueLightsFlight = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.TrueLightsFlight);
		TwilightBlaze = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.TwilightBlaze);
		TwoBecomeOne = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.TwoBecomeOne);
		UltimaWeaponKH1 = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.UltimaWeaponKH1);
		UltimaWeaponKH2 = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.UltimaWeaponKH2);
		UltimaWeaponBBS = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.UltimaWeaponBBS);
		UltimaWeaponDDD = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.UltimaWeaponDDD);
		Umbrella = new ItemKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Umbrella);
		Unbound = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.Unbound);
		UnicornisForetellersKeyblade = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.UnicornisForetellersKeyblade);
		UrsusForetellersKeyblade = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.UrsusForetellersKeyblade);
		VictoryLine = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.VictoryLine);
		VoidGear = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.VoidGear);
		VulpeusForetellersKeyblade = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.VulpeusForetellersKeyblade);
		WaytotheDawn = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.WaytotheDawn);
		WaywardWind = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.WaywardWind);
		WinnersProof = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.WinnersProof);
		WishingLamp = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.WishingLamp);
		WishingStar = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.WishingStar);
		WoodenKeyblade = new ItemKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.WoodenKeyblade);
		WoodenStick = new ItemKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.WoodenStick);
		YoungXehanortsKeyblade = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.YoungXehanortsKeyblade);
		ZeroOne = new ItemRealKeyblade(KEYBLADE,10,5).setUnlocalizedName(Strings.ZeroOne);
