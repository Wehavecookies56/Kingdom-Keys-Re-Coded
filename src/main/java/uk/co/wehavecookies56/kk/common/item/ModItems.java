...
public class ModItems {
	...
	///	for(int i=i; i<;i++)
		AbaddonPlasma = new ItemRealKeyblade(12, 2).setUnlocalizedName(Strings.AbaddonPlasma);
		AbyssalTide = new ItemRealKeyblade(12, 2).setUnlocalizedName(Strings.AbyssalTide);
		AllforOne = new ItemRealKeyblade(30,24).setUnlocalizedName(Strings.AllforOne);
		AnguisForetellersKeyblade = new ItemRealKeyblade(13, 8).setUnlocalizedName(Strings.AnguisForetellersKeyblade);
		AstralBlast = new ItemRealKeyblade(15, 2).setUnlocalizedName(Strings.AstralBlast);
		Aubade = new ItemRealKeyblade(12, 2).setUnlocalizedName(Strings.Aubade);
		BondofFlame = new ItemRealKeyblade(12,8).setUnlocalizedName(Strings.BondofFlame);
		Brightcrest = new ItemRealKeyblade(12, 14).setUnlocalizedName(Strings.Brightcrest);
		...
		CrownofGuilt = new ItemRealKeyblade(12, 6).setUnlocalizedName(Strings.CrownofGuilt);
		DarkerThanDark = new ItemRealKeyblade(48, 8).setUnlocalizedName(Strings.DarkerThanDark);
		...
		FrolicFlame = new ItemRealKeyblade(9, 6).setUnlocalizedName(Strings.FrolicFlame);
		GlimpseofDarkness = new ItemRealKeyblade(12, 2).setUnlocalizedName(Strings.GlimpseofDarkness);
		...
		KeybladeofPeoplesHearts = new ItemRealKeyblade(24, 12).setUnlocalizedName(Strings.KeybladeofPeoplesHearts);
		...
		LeasKeyblade = new ItemRealKeyblade(18, 20).setUnlocalizedName(Strings.LeasKeyblade);
		LeopardosForetellersKeyblade = new ItemRealKeyblade(21, 7).setUnlocalizedName(Strings.LeopardosForetellersKeyblade);
		Leviathan = new ItemRealKeyblade(12, 2).setUnlocalizedName(Strings.Leviathan);
		...
		LunarEclipse = new ItemRealKeyblade(18, 6).setUnlocalizedName(Strings.LunarEclipse);
		MarkofaHero = new ItemRealKeyblade(15,2).setUnlocalizedName(Strings.MarkofaHero);
		MasterXehanortsKeyblade = new ItemRealKeyblade(51, 20).setUnlocalizedName(Strings.MasterXehanortsKeyblade);
		MastersDefender = new ItemRealKeyblade(45, 24).setUnlocalizedName(Strings.MastersDefender);
		MaverickFlare = new ItemRealKeyblade(21, 8).setUnlocalizedName(Strings.MaverickFlare);
		MetalChocobo = new ItemRealKeyblade(30,-2).setUnlocalizedName(Strings.MetalChocobo);
		MidnightRoar = new ItemRealKeyblade(24, 4).setUnlocalizedName(Strings.MidnightRoar);
		MirageSplit = new ItemRealKeyblade(42, 16).setUnlocalizedName(Strings.MirageSplit);
		MissingAche = new ItemRealKeyblade(12, 0).setUnlocalizedName(Strings.MissingAche);
		...
		NightmaresEnd = new ItemRealKeyblade(42, 16).setUnlocalizedName(Strings.NightmaresEnd);
		NightmaresEndandMirageSplit = new ItemRealKeyblade(60, 24).setUnlocalizedName(Strings.NightmaresEndandMirageSplit);
		...
		OmegaWeapon = new ItemRealKeyblade(18, 6).setUnlocalizedName(Strings.OmegaWeapon);
		OminousBlight = new ItemRealKeyblade(15, 2).setUnlocalizedName(Strings.OminousBlight);
		OneWingedAngel = new ItemRealKeyblade(24,-4).setUnlocalizedName(Strings.OneWingedAngel);
		PainofSolitude = new ItemRealKeyblade(15, 4).setUnlocalizedName(Strings.PainofSolitude);
		...
		RejectionofFate = new ItemRealKeyblade(15, 2).setUnlocalizedName(Strings.RejectionofFate);
		...
		SignofInnocence = new ItemRealKeyblade(12, 4).setUnlocalizedName(Strings.SignofInnocence);
		SilentDirge = new ItemRealKeyblade(12, 6).setUnlocalizedName(Strings.SilentDirge);
		...
		SoulEater = new ItemRealKeyblade(39, 6).setUnlocalizedName(Strings.SoulEater);
		Spellbinder = new ItemRealKeyblade(12,4).setUnlocalizedName(Strings.Spellbinder);
		Starlight = new ItemRealKeyblade(12, 2).setUnlocalizedName(Strings.Starlight);
		StarSeeker = new ItemRealKeyblade(9,2).setUnlocalizedName(Strings.StarSeeker);
		Stormfall = new ItemRealKeyblade(15, 8).setUnlocalizedName(Strings.Stormfall);
		...
		SweetMemories = new ItemRealKeyblade(3, 8).setUnlocalizedName(Strings.SweetMemories);
		...
		TotalEclipse = new ItemRealKeyblade(15, 2).setUnlocalizedName(Strings.TotalEclipse);
		TreasureTrove = new ItemRealKeyblade(9,4).setUnlocalizedName(Strings.TreasureTrove);
		TrueLightsFlight = new ItemRealKeyblade(15, 2).setUnlocalizedName(Strings.TrueLightsFlight);
		TwilightBlaze = new ItemRealKeyblade(21, 2).setUnlocalizedName(Strings.TwilightBlaze);
		...
		Umbrella = new ItemKeyblade(9, 2).setUnlocalizedName(Strings.Umbrella);
		Unbound = new ItemRealKeyblade(27,28).setUnlocalizedName(Strings.Unbound);
		UnicornisForetellersKeyblade = new ItemRealKeyblade(19, 7).setUnlocalizedName(Strings.UnicornisForetellersKeyblade);
		UrsusForetellersKeyblade = new ItemRealKeyblade(22, 4).setUnlocalizedName(Strings.UrsusForetellersKeyblade);
		...
		VulpeusForetellersKeyblade = new ItemRealKeyblade(20, 5).setUnlocalizedName(Strings.VulpeusForetellersKeyblade);
		...
		WoodenKeyblade = new ItemKeyblade(6, 0).setUnlocalizedName(Strings.WoodenKeyblade);
		WoodenStick = new ItemKeyblade(0, 0).setUnlocalizedName(Strings.WoodenStick);
		YoungXehanortsKeyblade = new ItemRealKeyblade(45,16).setUnlocalizedName(Strings.YoungXehanortsKeyblade);
		ZeroOne = new ItemRealKeyblade(33,12).setUnlocalizedName(Strings.ZeroOne);
