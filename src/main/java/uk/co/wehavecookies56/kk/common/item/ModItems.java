...
public class ModItems {
	...
	public static void init () {
		...
		AllforOne = new ItemRealKeyblade(5, 6).setUnlocalizedName(Strings.AllforOne);
		...
		Counterpoint = new ItemRealKeyblade(6, 7).setUnlocalizedName(Strings.Counterpoint);
		...
		CrownofGuilt = new ItemRealKeyblade(6, 1).setUnlocalizedName(Strings.CrownofGuilt);
		...
		Divewing = new ItemRealKeyblade(6, 8).setUnlocalizedName(Strings.Divewing);
		...
		DivineRose = new ItemRealKeyblade(10, 0).setUnlocalizedName(Strings.DivineRose);
		...
		DreamSword = new ItemKeyblade(8, 8).setUnlocalizedName(Strings.DreamSword);
		...
		EndofPain = new ItemRealKeyblade(7, 8).setUnlocalizedName(Strings.EndofPain);
		...
		FairyHarp = new ItemRealKeyblade(8, 1).setUnlocalizedName(Strings.FairyHarp);
		...
		FerrisGear = new ItemRealKeyblade(4, 4).setUnlocalizedName(Strings.FerrisGear);
		...
		GuardianBell = new ItemRealKeyblade(3, 5).setUnlocalizedName(Strings.GuardianBell);
		...
		KnockoutPunch = new ItemRealKeyblade(6, 5).setUnlocalizedName(Strings.KnockoutPunch);
		...
		Lionheart = new ItemRealKeyblade(10, 1).setUnlocalizedName(Strings.Lionheart);
		...
		NightmaresEndandMirageSplit = new ItemRealKeyblade(15, 9).setUnlocalizedName(Strings.NightmaresEndandMirageSplit);
		...
		OceansRage = new ItemRealKeyblade(4, 5).setUnlocalizedName(Strings.OceansRage);
		...
		OneWingedAngel = new ItemRealKeyblade(8, -2).setUnlocalizedName(Strings.OneWingedAngel);
		...
		SweetDreams = new ItemRealKeyblade(7, 6).setUnlocalizedName(Strings.SweetDreams);
		...
		UltimaWeaponKH1 = new ItemRealKeyblade(14, 2).setUnlocalizedName(Strings.UltimaWeaponKH1);
		...
		UltimaWeaponBBS = new ItemRealKeyblade(7, 6).setUnlocalizedName(Strings.UltimaWeaponBBS);
        ((ItemKeyblade)UltimaWeaponBBS).setDescription("The most powerful of Keyblades.");
		UltimaWeaponDDD = new ItemRealKeyblade(8, 8).setUnlocalizedName(Strings.UltimaWeaponDDD);
		...
		Unbound = new ItemRealKeyblade(9, 7).setUnlocalizedName(Strings.Unbound);
		...
		VoidGear = new ItemRealKeyblade(8, 4).setUnlocalizedName(Strings.VoidGear);
		...
		WaytotheDawn = new ItemRealKeyblade(6, 3).setUnlocalizedName(Strings.WaytotheDawn);
		...
		YoungXehanortsKeyblade = new ItemRealKeyblade(12, 8).setUnlocalizedName(Strings.YoungXehanortsKeyblade);
