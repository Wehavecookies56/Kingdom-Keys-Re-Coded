...
public class ModItems {
	...
	public static void init () {
		...
		AbaddonPlasma = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.AbaddonPlasma);
		AbyssalTide = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.AbyssalTide);
		AllforOne = new ItemRealKeyblade(30,24).setUnlocalizedName(Strings.AllforOne);
		AnguisForetellersKeyblade = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.AnguisForetellersKeyblade);
		AstralBlast = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.AstralBlast);
		Aubade = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.Aubade);
		BondofFlame = new ItemRealKeyblade(12,8).setUnlocalizedName(Strings.BondofFlame);
		Brightcrest = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.Brightcrest);
		...
		CrownofGuilt = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.CrownofGuilt);
		DarkerThanDark = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.DarkerThanDark);
		Darkgnaw = new ItemRealKeyblade(15,4).setUnlocalizedName(Strings.Darkgnaw);
		DecisivePumpkin = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.DecisivePumpkin);
		DestinysEmbrace = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.DestinysEmbrace);
		...
		FrolicFlame = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.FrolicFlame);
		GlimpseofDarkness = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.GlimpseofDarkness);
		...
		KeybladeofPeoplesHearts = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.KeybladeofPeoplesHearts);
		...
		LeasKeyblade = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.LeasKeyblade);
		LeopardosForetellersKeyblade = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.LeopardosForetellersKeyblade);
		Leviathan = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.Leviathan);
		Lionheart = new ItemRealKeyblade(30,2).setUnlocalizedName(Strings.Lionheart);
		LostMemory = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.LostMemory);
		LunarEclipse = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.LunarEclipse);
		MarkofaHero = new ItemRealKeyblade(15,2).setUnlocalizedName(Strings.MarkofaHero);
		MasterXehanortsKeyblade = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.MasterXehanortsKeyblade);
		MastersDefender = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.MastersDefender);
		MaverickFlare = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.MaverickFlare);
		MetalChocobo = new ItemRealKeyblade(30,-2).setUnlocalizedName(Strings.MetalChocobo);
		MidnightRoar = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.MidnightRoar);
		MirageSplit = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.MirageSplit);
		MissingAche = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.MissingAche);
		...
		NightmaresEnd = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.NightmaresEnd);
		NightmaresEndandMirageSplit = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.NightmaresEndandMirageSplit);
		...
		OmegaWeapon = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.OmegaWeapon);
		OminousBlight = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.OminousBlight);
		OneWingedAngel = new ItemRealKeyblade(24,-4).setUnlocalizedName(Strings.OneWingedAngel);
		PainofSolitude = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.PainofSolitude);
		...
		RejectionofFate = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.RejectionofFate);
		...
		SignofInnocence = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.SignofInnocence);
		SilentDirge = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.SilentDirge);
		...
		SoulEater = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.SoulEater);
		Spellbinder = new ItemRealKeyblade(12,4).setUnlocalizedName(Strings.Spellbinder);
		Starlight = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.Starlight);
		StarSeeker = new ItemRealKeyblade(9,2).setUnlocalizedName(Strings.StarSeeker);
		Stormfall = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.Stormfall);
		StrokeofMidnight = new ItemRealKeyblade(6,4).setUnlocalizedName(Strings.StrokeofMidnight);
		SweetDreams = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.SweetDreams);
		SweetMemories = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.SweetMemories);
		Sweetstack = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.Sweetstack);
		ThreeWishes = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.ThreeWishes);
		TotalEclipse = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.TotalEclipse);
		TreasureTrove = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.TreasureTrove);
		TrueLightsFlight = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.TrueLightsFlight);
		TwilightBlaze = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.TwilightBlaze);
		TwoBecomeOne = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.TwoBecomeOne);
		UltimaWeaponKH1 = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.UltimaWeaponKH1);
		UltimaWeaponKH2 = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.UltimaWeaponKH2);
		UltimaWeaponBBS = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.UltimaWeaponBBS);
		UltimaWeaponDDD = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.UltimaWeaponDDD);
		Umbrella = new ItemKeyblade(str,mag).setUnlocalizedName(Strings.Umbrella);
		Unbound = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.Unbound);
		UnicornisForetellersKeyblade = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.UnicornisForetellersKeyblade);
		UrsusForetellersKeyblade = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.UrsusForetellersKeyblade);
		VictoryLine = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.VictoryLine);
		VoidGear = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.VoidGear);
		VulpeusForetellersKeyblade = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.VulpeusForetellersKeyblade);
		WaytotheDawn = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.WaytotheDawn);
		WaywardWind = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.WaywardWind);
		WinnersProof = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.WinnersProof);
		WishingLamp = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.WishingLamp);
		WishingStar = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.WishingStar);
		WoodenKeyblade = new ItemKeyblade(str,mag).setUnlocalizedName(Strings.WoodenKeyblade);
		WoodenStick = new ItemKeyblade(str,mag).setUnlocalizedName(Strings.WoodenStick);
		YoungXehanortsKeyblade = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.YoungXehanortsKeyblade);
		ZeroOne = new ItemRealKeyblade(str,mag).setUnlocalizedName(Strings.ZeroOne);
