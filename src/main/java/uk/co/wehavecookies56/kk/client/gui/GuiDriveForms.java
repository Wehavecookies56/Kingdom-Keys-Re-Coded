...
public class GuiDriveForms extends GuiContainer {
    ...
    public GuiDriveForms (EntityPlayer player, InventoryPlayer inventoryPlayer) {
        super(new ContainerDriveForms(player, inventoryPlayer));
        this.inventory = player.getCapability(ModCapabilities.DRIVE_STATE, null).getInventoryDriveForms();
    }
    ...
    protected void drawGuiContainerForegroundLayer (int mouseX, int mouseY) {
        String s = InventoryDriveForms.name;
