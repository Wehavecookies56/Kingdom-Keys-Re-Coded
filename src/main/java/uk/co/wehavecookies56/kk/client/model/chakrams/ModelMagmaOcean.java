...
public class ModelMagmaOcean extends ModelBase {
    OBJModel model;
    HashMap<String, IBakedModel> modelParts;

    public ModelMagmaOcean () {
        try {
            model = (OBJModel) OBJLoader.INSTANCE.loadModel(new ResourceLocation("kk:models/item/magmaocean.obj"));
