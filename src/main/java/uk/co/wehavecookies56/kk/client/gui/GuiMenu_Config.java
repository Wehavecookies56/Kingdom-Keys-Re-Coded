...
public class GuiMenu_Config extends GuiMenu_Bars {
    ...
    public void initGui () {
        ...
        a = new GuiNumberTextField(A, mc.fontRenderer, aPosX, 179, boxWidth, 10, 255);
        ...
        buttonList.add(back = new GuiButton(BACK, 5, 190, 100, 20, Utils.translateToLocal(Strings.Gui_Menu_Items_Button_Back)));
        ...
        this.a.setText(String.valueOf(MainConfig.client.hud.guiAlpha));
        updateButtons();
    }
    ...
    public void drawScreen (int mouseX, int mouseY, float partialTicks) {
        ...
        this.a.drawTextBox();
        this.drawString(mc.fontRenderer, "Command Menu Alpha:", 5, 180, 0xFFFFFF);
