...
import uk.co.wehavecookies56.kk.client.model.ModelSizzlingEdge;
 ...
 */
public class RenderEntitySizzlingEdge extends Render implements IRenderFactory<EntitySizzlingEdge> {
    ...
    protected ResourceLocation getEntityTexture (Entity entity) {
        return new ResourceLocation(Reference.MODID, "textures/items/models/" + Strings.SizzlingEdge + ".png");
    }
    ...
    public Render<? super EntitySizzlingEdge> createRenderFor (RenderManager manager) {
        return new RenderEntitySizzlingEdge(manager);
    }
