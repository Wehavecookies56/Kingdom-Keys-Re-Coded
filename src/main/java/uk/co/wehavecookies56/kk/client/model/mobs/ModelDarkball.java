 ...
 */
public class ModelDarkball extends ModelBase 
{
    ...
    private double[] chargeHeadAnimation = new double[] 
    		{-2, -6, -10, -14, -18, -14, -10, -6, -2, 2, 6, 10, 14, 18};
	
	public ModelDarkball() 
	{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) 
	{
		...
		if(EntityHelper.getState(entity) != 3)
		{
			this.body1.render(f5);
			this.antenna11.render(f5);
			this.antenna21.render(f5);
			this.antenna31.render(f5);
		}
	}
