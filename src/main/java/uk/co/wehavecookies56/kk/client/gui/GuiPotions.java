...
public class GuiPotions extends GuiContainer {
	...
	public GuiPotions (EntityPlayer player, InventoryPlayer inventoryPlayer) {
		super(new ContainerPotionsMenu(player, inventoryPlayer));
		inventory = player.getCapability(ModCapabilities.PLAYER_STATS, null).getInventoryPotionsMenu();
	}
	...
	protected void drawGuiContainerForegroundLayer (int mouseX, int mouseY) {
		String s = InventoryPotionsMenu.name;
