...
import uk.co.wehavecookies56.kk.client.model.ModelIfrit;
...
public class RenderEntityProminence extends Render implements IRenderFactory<EntityProminence> {
	...
	protected ResourceLocation getEntityTexture (Entity entity) {
		return new ResourceLocation(Reference.MODID, "textures/items/models/" + Strings.Prominence + ".png");
	}
	...
	@Override
	public Render<? super EntityProminence> createRenderFor (RenderManager manager) {
		return new RenderEntityProminence(manager);
	}
