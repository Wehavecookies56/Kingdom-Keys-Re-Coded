...
public class ModelVolcanics extends ModelBase {
    OBJModel model;
    HashMap<String, IBakedModel> modelParts;

    public ModelVolcanics () {
        try {
            model = (OBJModel) OBJLoader.INSTANCE.loadModel(new ResourceLocation("kk:models/item/volcanics.obj"));
