...
public class RenderEntityVolcanics extends Render implements IRenderFactory<EntityVolcanics> {
    ...
    protected ResourceLocation getEntityTexture (Entity entity) {
        return new ResourceLocation(Reference.MODID, "textures/items/models/" + Strings.Volcanics + ".png");
    }
    ...
    @Override
    public Render<? super EntityVolcanics> createRenderFor (RenderManager manager) {
        return new RenderEntityVolcanics(manager);
    }
