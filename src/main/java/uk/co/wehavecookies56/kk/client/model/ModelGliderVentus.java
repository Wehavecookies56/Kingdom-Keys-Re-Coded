...
public class ModelGliderVentus extends ModelBase {

	OBJModel model;
	HashMap<String, IBakedModel> modelParts;

	public ModelGliderVentus() {
		try {
			model = (OBJModel) OBJLoader.INSTANCE.loadModel(new ResourceLocation("kk:models/entity/ventus.obj"));
