...
public class ModelGliderTerra extends ModelBase {
	
    OBJModel model;
    HashMap<String, IBakedModel> modelParts;

    public ModelGliderTerra() {
        try {
            model = (OBJModel) OBJLoader.INSTANCE.loadModel(new ResourceLocation("kk","models/entity/terra.obj"));
