...
public class GuiMenu_Status extends GuiMenu_Bars {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (selected == STATS_PLAYER) {
			...
			drawString(fontRenderer, "" + STATS.getConsumedAP()+"/"+STATS.getMaxAP(), 230, ((-140 / 16) + 75) + 70, 0xFFD900);
			...
			drawString(fontRenderer, "" + DRIVE.getDriveLevel(form), 230, ((-140 / 16) + 75) + 10, 0xFFD900);
			drawString(fontRenderer, "" + DRIVE.getDriveExp(form), 230, ((-140 / 16) + 75) + 22, 0xFFD900);
			drawString(fontRenderer, "" + remainingExp, 230, ((-140 / 16) + 75) + 34, 0xFFD900);
			drawString(fontRenderer, "" + DRIVE.getFormGaugeLevel(form), 230, ((-140 / 16) + 75) + 46, 0xFFD900);
		}
	}
