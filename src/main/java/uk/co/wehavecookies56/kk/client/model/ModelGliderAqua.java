...
public class ModelGliderAqua extends ModelBase {

	OBJModel model;
	HashMap<String, IBakedModel> modelParts;

	public ModelGliderAqua() {
		try {
			model = (OBJModel) OBJLoader.INSTANCE.loadModel(new ResourceLocation("kk:models/entity/aqua.obj"));
